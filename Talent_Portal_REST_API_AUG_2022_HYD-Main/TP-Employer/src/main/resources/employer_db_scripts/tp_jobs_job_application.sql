...
CREATE TABLE `job_application` (
  ...
  `status_id` varchar(60) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `job_application` VALUES (1,1,'Aarav@234','1'),(2,1,'Riya234','4'),(3,2,'Riya234','2'),(4,2,'Aarav@234','6'),(5,2,'kanika.s','3');
...
-- Dump completed on 2022-10-06 12:40:01
