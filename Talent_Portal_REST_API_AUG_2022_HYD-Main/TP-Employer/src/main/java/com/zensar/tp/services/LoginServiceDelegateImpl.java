...
public class LoginServiceDelegateImpl implements LoginServiceDelegate{
    ...
    @Override
  @CircuitBreaker(name="Employer-service-Token",fallbackMethod="fallbackForGetten")
	...
	@Override
	@CircuitBreaker(name="Employer-service-Token",fallbackMethod="fallbackForRole")
	...
	@Override
	@CircuitBreaker(name="Employer-service-Token",fallbackMethod="fallbackForUsername")
	...
	public String fallbackForUsername(String authToken,Exception e) {
		System.out.println("Username Not Working");
		return null;
	}
